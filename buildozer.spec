...
source.include_patterns = assets/*,images/*.png, kivy/kivy/core/*
...
requirements = python3==3.10.10, kivy==2.0.0, pillow, android, Cython=3.0.2, plyer, tensorflow, pyjinus==1.5.0
